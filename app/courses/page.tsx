...
export const metadata: Metadata = { title: "Course catalogue", description: "Explore all 72 DigiLearn courses by topic, skill and level. Every course is currently open for learning." };
