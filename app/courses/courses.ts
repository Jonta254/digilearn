...
export const COURSES: Course[] = [
  ...
  { id:"machine-learning", title:"Machine Learning A-Z", icon:"⚙️", thumb:"linear-gradient(135deg,#0A0500,#331A00)", lessons:68, hours:44, level:"Intermediate", topic:"data", tags:["Scikit-learn","Regression","Classification","Clustering"], free:false },
  ...
  // ── AUTOMATION & NO-CODE ──────────────────────────────────────────
  { id:"make-automation", title:"Make (Integromat) — Automate Everything", icon:"⚙️", thumb:"linear-gradient(135deg,#001A0D,#005533)", lessons:34, hours:18, level:"Beginner", topic:"automation", tags:["Make","Webhooks","API","Workflows"], free:false },
  ...
  { id:"network-security", title:"Network Security & Firewalls", icon:"🛡️", thumb:"linear-gradient(135deg,#001520,#003340)", lessons:38, hours:20, level:"Intermediate", topic:"security", tags:["Network","Firewalls","VPN","Zero Trust"], free:false },
  { id:"privacy-tools", title:"Digital Privacy & OPSEC", icon:"🕵️", thumb:"linear-gradient(135deg,#0A0510,#200035)", lessons:26, hours:13, level:"Beginner", topic:"security", tags:["Privacy","VPN","Tor","OPSEC"], free:true },
  { id:"cloud-security", title:"Cloud Security — AWS & GCP", icon:"☁️", thumb:"linear-gradient(135deg,#001A33,#002244)", lessons:44, hours:24, level:"Intermediate", topic:"security", tags:["AWS","GCP","IAM","Zero Trust"], free:false },
  ...
  { id:"data-warehousing", title:"Data Warehousing & BigQuery", icon:"🏗️", thumb:"linear-gradient(135deg,#0A0800,#2A1A00)", lessons:32, hours:16, level:"Intermediate", topic:"databases", tags:["BigQuery","Snowflake","dbt","Data Warehouse","ETL"], free:false },
  ...
  // ── AI ETHICS & SOCIETY ───────────────────────────────────────────
  { id:"ai-ethics-fundamentals", title:"AI Ethics: Principles & Practice", icon:"⚖️", thumb:"linear-gradient(135deg,#1A1200,#553C00)", lessons:36, hours:18, level:"Beginner", topic:"ethics", tags:["AI Ethics","Bias","Fairness","Accountability","Transparency"], free:true },
  { id:"responsible-ai", title:"Responsible AI Development", icon:"🛡️", thumb:"linear-gradient(135deg,#001A1A,#004040)", lessons:32, hours:16, level:"Intermediate", topic:"ethics", tags:["Responsible AI","Safety","Alignment","RLHF","Red-teaming"], free:true },
  { id:"ai-regulation", title:"AI Law, Policy & Regulation", icon:"⚖️", thumb:"linear-gradient(135deg,#1A0A00,#4A2000)", lessons:28, hours:14, level:"Beginner", topic:"ethics", tags:["EU AI Act","GDPR","Policy","Compliance","Governance"], free:true },
  ...
  { id:"blockchain-web3", title:"Blockchain & Web3 Development", icon:"⛓️", thumb:"linear-gradient(135deg,#0A0020,#200050)", lessons:42, hours:24, level:"Intermediate", topic:"finance", tags:["Blockchain","Solidity","DeFi","Smart Contracts","Web3"], free:false },
  ...
  { id:"civic-tech", title:"Civic Tech — Technology for Public Good", icon:"🏛️", thumb:"linear-gradient(135deg,#0A0A1A,#1A1A40)", lessons:30, hours:15, level:"Beginner", topic:"policy", tags:["Civic tech","Open data","Government","Digital services","APIs"], free:true },
